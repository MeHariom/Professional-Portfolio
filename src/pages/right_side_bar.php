<div class="right-side d-none d-lg-block">
    ...
    <div class="social-box">
        ...
        <div class="social d-none d-lg-block">
            <a target="_blank" href="https://wa.me/9508383932">
                <i class="bi bi-whatsapp"></i>
            </a>
            <a target="_blank" href="https://www.linkedin.com/in/hari-om-70a01a17b/">
                <i class="bi bi-linkedin"></i>
            </a>
            <a target="_blank" href="https://www.instagram.com/h__om____17/">
                <i class="bi bi-instagram"></i>
            </a>
            <a target="_blank" href="">
                <i class="bi bi-facebook"></i>
            </a>
            <a target="_blank" href="https://github.com/MeHariom">
